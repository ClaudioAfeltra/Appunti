...
Dato uno spazio $A$ affine su $V$ e dati i riferimenti affini $L=(P_0,P_1,\ldots,P_n)$
 ...
 \begin{remark}
 la mappa $\phi:\K^n\rightarrow \K^{n+1}$, $x\mapsto\left( \begin{matrix}
                                                              x\\
                                                              \hline
                                                              1
                                                             \end{matrix} \right)
...
$H=\{x\in \K^{n+1} : x_{n+1}=0\}$ il quale è sottospazio affine di $\K^{n+1}$.
 ...
 allora si deve avere che la $n+1$ -esima componente di $g\left( \begin{matrix}
                                                              x\\
                                                              \hline
                                                              1
                                                             \end{matrix} \right)$ sia ancora $1$,
